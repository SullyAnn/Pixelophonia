<template>
  <main>
    ...
    <div id="addQuestion" class="window">
        ...
        <form>
        <input type="text" placeholder="Libellé de la question" class="labelChoice">
        <input type="text" placeholder="Où allons-nous ?" class="labelChoice">
        
        <div class="choices2">
        <fieldset>
            <legend>Choix n°1</legend>
            <input type = "text" placeholder="Choix n°1" class="labelChoice">
            <label for="choice1" class="importImg">Choisir une image</label>
            <input type="file" id="choice1" accept="image/*" style="display: none">

        </fieldset>

        <fieldset>
            <legend>Choix n°2</legend>
            <input type = "text" placeholder="Choix n°2" class="labelChoice">
            <label for="choice2" class="importImg">Choisir une image</label>
            <input type="file" id="choice2" accept="image/*" style="display: none">
        </fieldset>
        </div>
